...
function TicketPDFDocument({ ticket, isDark }) {
  ...
  const bookingRef = ticket?.booking_id
        ...
        <div style={{ padding: '20px 24px' }}>
          ...
          >
            <div>
              ...
              <p style={{ ...valueStyle, fontFamily: 'monospace' }}>
                {ticketId}
              </p>
            </div>
            {totalAmt != null && (
  ...
  async function handlePDFDownload() {
    ...
    try {
      ...
      const blob = await pdf(
        <TicketPDFDocument ticket={ticket} isDark={isDark} />
      ).toBlob();
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted mt-0.5">
                    High-res image · Best for sharing
                  </p>
                </div>
              </button>
