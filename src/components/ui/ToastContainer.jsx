...
function ToastItem({ toast, onDismiss, isMobile }) {
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="absolute left-0 top-0 bottom-0 w-[3px] rounded-1-border"
  ...
  return (
    <>
      <div
        ...
        className="fixed z-[9997] pointer-events-none bottom-0 left-0 right-0 px-4 pb-6 flex flex-col gap-2.5 md:bottom-auto md:top-5 md:right-5 md:left-auto md:w-auto md:max-w-sm md:px-0 md:p-0"
      >
        {toasts.map((toast) => (
